...
assert(!previewKeyCellHtml(pinyin26LandscapeHtml, 'space').includes('>space</span>'), '中文 26 键横屏默认空格不应回退显示 space 文本。');
assert(!previewClassCellHtml(alphabeticStandardLandscapeHtml, 'space').includes('>space</span>'), '英文 26 键横屏默认空格不应回退显示 space 文本。');
assert(
