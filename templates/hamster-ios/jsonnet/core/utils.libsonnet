...
local makeSystemImageStyle(params={}) =
  std.prune({
    ...
    highlightSystemImageName: std.get(params, 'highlightSystemImageName'),
...
local makeGeometryStyle(params={}) =
  std.prune({
    ...
    normalBorderColor: std.get(params, 'normalBorderColor', std.get(params, 'borderColor')),
...
local makeFileImageStyle(params={}) =
  std.prune({
...

{
  ...
  makeFileImageStyle: makeFileImageStyle,
